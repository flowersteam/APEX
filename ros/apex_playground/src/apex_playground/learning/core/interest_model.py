...
class ContextRandomInterest(MiscRandomInterest):
    ...
    def competence_measure(self, csg, cs, dist_max):
        ...
        # return self.competence_measure(s, sg, dist_max=dist_max) / dist_max  # Normalize
        return self.competence_measure(s, sg, dist_max=dist_max)


class ContextGaussianInterest(MiscGaussianInterest):
    def __init__(self,
                 conf,
                 expl_dims,
                 competence_measure,
        ...
        MiscGaussianInterest.__init__(self,
                                      conf,
                                      expl_dims,
                                      competence_measure,
                                      win_size,
