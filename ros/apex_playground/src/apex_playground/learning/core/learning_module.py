...
class LearningModule(Agent):
    ...
    def produce(self, context=None, explore=True, n=1):
        if self.t < self.motor_babbling_n_iter:
            ...
            self.y = self.infer(self.expl_dims, self.inf_dims, self.x, explore=explore, n=n)
    ...
    def progress(self):
        return self.interest_model.progress()
